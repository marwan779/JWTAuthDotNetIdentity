...
namespace JWTAuthDotNetIdentity.Migrations
{
    ...
    [Migration("20250608125258_AddingChangeEmailTokensTable")]
    partial class AddingChangeEmailTokensTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JWTAuthDotNetIdentity.Models.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("JWTAuthDotNetIdentity.Models.Entities.ChangeEmailToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("JWTAuthDotNetIdentity.Models.RefreshToken", b =>
                {
                    b.HasOne("JWTAuthDotNetIdentity.Models.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JWTAuthDotNetIdentity.Models.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
